...
#> 1 large[[1]]    120ns    131ns  6647450.        0B     665.
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    200ns    240ns  3690057.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       120ns    150ns  6031727.        0B     603.
#> 2 by_index      120ns    131ns  6612396.        0B       0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       619µs    632µs     1581.        0B        0
#> 2 by_index      120ns    140ns  6545917.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           620µs    632µs     1580.        0B        0
#> 2 by_index          110ns    131ns  6658924.        0B        0
#> 3 by_hashed_name    821ns    892ns   748785.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup   37.3µs   37.9µs    25397.        0B        0
#> 2 base_one_lookup     620.3µs  634.2µs     1575.    21.6KB        0
```
