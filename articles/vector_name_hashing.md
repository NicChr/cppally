...
#> 1 large[[1]]    110ns    140ns  6565880.        0B     657.
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    200ns    230ns  3952964.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       121ns    150ns  6038662.        0B     604.
#> 2 by_index      110ns    131ns  6692010.        0B       0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       582µs    594µs     1682.        0B        0
#> 2 by_index      110ns    131ns  6783797.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           581µs    593µs     1682.        0B        0
#> 2 by_index          110ns    131ns  6665820.        0B        0
#> 3 by_hashed_name    821ns    901ns   717064.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup   37.3µs     38µs    25342.        0B        0
#> 2 base_one_lookup     583.2µs    597µs     1670.    21.6KB        0
```
