...
#> 1 large[[1]]    103ns    117ns  7589121.        0B     759.
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    178ns    192ns  5008108.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       111ns    123ns  6758332.        0B     676.
#> 2 by_index       92ns    119ns  7659176.        0B       0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       458µs    533µs     1889.        0B        0
#> 2 by_index       92ns    101ns  8993507.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           458µs    554µs     1816.        0B        0
#> 2 by_index           92ns    103ns  8088616.        0B        0
#> 3 by_hashed_name    615ns    727ns   981210.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup     30µs   35.2µs    27985.        0B        0
#> 2 base_one_lookup       464µs  538.3µs     1872.    21.6KB        0
```
