...
#> 1 large[[1]]    130ns    141ns  6587419.        0B     659.
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    210ns    231ns  4044228.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       150ns    170ns  5695964.        0B     570.
#> 2 by_index      130ns    150ns  6483986.        0B       0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       553µs    568µs     1758.        0B        0
#> 2 by_index      130ns    141ns  6705246.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           556µs    568µs     1756.        0B        0
#> 2 by_index          130ns    141ns  6249913.        0B        0
#> 3 by_hashed_name    861ns    902ns   786127.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup   33.6µs     34µs    28227.        0B        0
#> 2 base_one_lookup     555.5µs    571µs     1750.    21.6KB        0
```
