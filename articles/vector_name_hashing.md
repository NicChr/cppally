...
#> 1 large[[1]]    130ns    150ns  6213910.        0B     621.
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    210ns    231ns  4104645.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       141ns    161ns  5814059.        0B     581.
#> 2 by_index      130ns    150ns  6263174.        0B       0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       559µs    571µs     1755.        0B        0
#> 2 by_index      130ns    150ns  6299426.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           544µs    556µs     1804.        0B        0
#> 2 by_index          130ns    150ns  6271800.        0B        0
#> 3 by_hashed_name    861ns    901ns   784150.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup   64.5µs   65.3µs    14911.        0B        0
#> 2 base_one_lookup       554µs  566.8µs     1761.    21.6KB        0
```
