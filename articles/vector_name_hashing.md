...
#> 1 large[[1]]    130ns    150ns  6195831.        0B     620.
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    210ns    240ns  3940931.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       150ns    161ns  5787650.        0B     579.
#> 2 by_index      130ns    150ns  6166638.        0B       0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       553µs    565µs     1756.        0B        0
#> 2 by_index      130ns    150ns  6517117.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           553µs    567µs     1739.        0B        0
#> 2 by_index          130ns    150ns  5923790.        0B        0
#> 3 by_hashed_name    871ns    902ns   782378.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup   33.5µs   34.1µs    28079.        0B        0
#> 2 base_one_lookup     560.3µs  572.7µs     1745.    21.6KB        0
```
