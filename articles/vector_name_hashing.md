...
#> 1 large[[1]]    110ns    131ns  6577231.        0B     658.
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    200ns    230ns  3907971.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       120ns    150ns  5985035.        0B     599.
#> 2 by_index      110ns    131ns  6428339.        0B       0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       587µs    600µs     1669.        0B        0
#> 2 by_index      110ns    136ns  6772107.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           587µs    600µs     1668.        0B        0
#> 2 by_index          110ns    131ns  6609795.        0B        0
#> 3 by_hashed_name    821ns    901ns   747511.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup   37.1µs   37.9µs    25440.        0B        0
#> 2 base_one_lookup     556.5µs  569.8µs     1747.    21.6KB        0
```
