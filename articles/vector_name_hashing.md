...
#> 1 large[[1]]    110ns    130ns  6843554.        0B     684.
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    200ns    231ns  3898366.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       120ns    150ns  6073139.        0B     607.
#> 2 by_index      110ns    131ns  6532797.        0B       0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       590µs    604µs     1657.        0B        0
#> 2 by_index      110ns    131ns  6933668.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           589µs    604µs     1655.        0B        0
#> 2 by_index          110ns    130ns  6740232.        0B        0
#> 3 by_hashed_name    821ns    911ns   733435.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup   72.2µs   73.4µs    13309.        0B        0
#> 2 base_one_lookup     593.2µs  608.6µs     1641.    21.6KB        0
```
