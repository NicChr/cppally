...
#> 1 large[[1]]    140ns    160ns  5888554.        0B        0
mark(large[[length(large)]])
#> # A tibble: 1 × 6
#>   expression                  min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>             <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 large[[length(large)]]    230ns    251ns  3708514.        0B        0
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       160ns    181ns  5249648.        0B       0 
#> 2 by_index      140ns    160ns  5854078.        0B     585.
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name       537µs    549µs     1826.        0B        0
#> 2 by_index      140ns    151ns  6134506.        0B        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 by_name           537µs    549µs     1824.        0B        0
#> 2 by_index          130ns    160ns  5973308.        0B        0
#> 3 by_hashed_name    901ns    942ns   771299.        0B        0
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_one_lookup   33.5µs   33.9µs    28394.        0B        0
#> 2 base_one_lookup     537.2µs  549.1µs     1816.    21.6KB        0
```
