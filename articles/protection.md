...
On my machine, cpp11 performs an insert & release every ~54 nanoseconds.
cppally performs better, with ~28 nanoseconds per insert & release.
...
at ~52 ns/copy and cppally at ~0.4 ns/copy.
...
#> 1 C_na_count(x)   41.1µs   71.4µs    13938.        0B        0
```
...
#>   expression             min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>        <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cpp11_na_count(x)   8.64ms     10ms      101.        0B     31.7
```
...
#>   expression               min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>          <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_na_count(x)   1.38ms   1.39ms      718.        0B        0
```
...
#>   expression                    min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>               <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_fast_na_count(x)   71.1µs   71.5µs    13722.        0B        0
```
...
#>   expression                       min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>                  <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_fast_na_count_v2(x)   40.9µs   71.5µs    13918.        0B        0
```
