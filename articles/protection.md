...
On my machine, cpp11 performs an insert & release every ~35 nanoseconds.
cppally performs better, with ~12 nanoseconds per insert & release.
...
at ~32 ns/copy and cppally at ~0.3 ns/copy.
...
#> 1 C_na_count(x)   30.3µs   33.2µs    29374.        0B        0
```
...
#>   expression             min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>        <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cpp11_na_count(x)   6.64ms   6.93ms      140.        0B     45.9
```
...
#>   expression               min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>          <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_na_count(x)    913µs    970µs     1010.        0B        0
```
...
#>   expression                    min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>               <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_fast_na_count(x)   56.4µs   58.1µs    16619.        0B     2.01
```
...
#>   expression                       min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>                  <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cppally_fast_na_count_v2(x)   30.4µs   33.2µs    29146.        0B        0
```
