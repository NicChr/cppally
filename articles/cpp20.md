...
✔ generated file cpp20.R
✔ generated file cpp20.cppℹ Loading cpp20
ℹ Re-compiling cpp20── R CMD INSTALL ─────────────────────────────────────────────────────────────────────────────────────────────────────────
─  installing *source* package 'cpp20' ... (342ms)
   ** this is package 'cpp20' version '0.0.0.9000'
   ** using staged installation
   ** libs
   using C++ compiler: 'G__~1.EXE (GCC) 14.2.0'
   using C++20
   g++  -std=gnu++20 -I"C:/PROGRA~1/R/R-45~1.2/include" -DNDEBUG -I../inst/include    -I"C:/rtools45/x86_64-w64-mingw32.static.posix/include"   -fopenmp -Wa,-mbig-obj   -O2 -Wall  -mfpmath=sse -msse2 -mstackrealign   -Wall -pedantic -fdiagnostics-color=always -Wall -pedantic -fdiagnostics-color=always  -c cpp20.cpp -o cpp20.o
   g++  -std=gnu++20 -I"C:/PROGRA~1/R/R-45~1.2/include" -DNDEBUG -I../inst/include    -I"C:/rtools45/x86_64-w64-mingw32.static.posix/include"   -fopenmp -Wa,-mbig-obj   -O2 -Wall  -mfpmath=sse -msse2 -mstackrealign   -Wall -pedantic -fdiagnostics-color=always -Wall -pedantic -fdiagnostics-color=always  -c foo.cpp -o foo.o
...
**Note:** We aim to integrate cpp20 registration into the `devtools`
...
| cpp20 type         | Description                      | Implicitly converts to           |
|:-------------------|----------------------------------|:---------------------------------|
...
2.  `r_sexp` represents a generic R object which can include cpp20
