...
'-CPPALLY_PRESERVE_ALTREP' flag to Makevars.
...
Please note that other 64-bit signed integer types like `int64_t`, `R_xlen_t`, or cppally's identical `r_size_t` will convert to 64-bit integer vectors when returned to R.
