...
For info on using cppally see [Getting started with cppally](https://nicchr.github.io/cpp20/articles/cpp20.html)
...
Like the excellent cpp11 package, cppally also handles automatic protection for R objects. For more info see [Automatic Protection](https://nicchr.github.io/cpp20/articles/protection.html)
