...
#> 1 last_altrep… 3.75µs 5.42µs   181163.    3.18KB        0 10000     0     55.2ms
#> # ℹ 4 more variables: result <list>, memory <list>, time <list>, gc <list>
mark(last_altrep_unaware(1:10^5)) # Materialises full vector
#> # A tibble: 1 × 13
#>   expression      min median `itr/sec` mem_alloc `gc/sec` n_itr  n_gc total_time
#>   <bch:expr>   <bch:> <bch:>     <dbl> <bch:byt>    <dbl> <int> <dbl>   <bch:tm>
#> 1 last_altrep… 39.9µs 40.8µs    21109.     391KB     171.  3707    30      176ms
#> # ℹ 4 more variables: result <list>, memory <list>, time <list>, gc <list>
...
#> 1 reverse(x)    527µs  575µs     1694.     391KB     12.7   803     6      474ms
#> # ℹ 4 more variables: result <list>, memory <list>, time <list>, gc <list>
...
#> 1 r_reverse   228.8µs  241µs     3963.     781KB     63.3  1189    19      300ms
#> 2 cppally_co… 555.9µs  575µs     1706.     391KB     12.7   805     6      472ms
#> 3 cppally_no…  75.1µs  216µs     6182.     391KB     47.8  2455    19      397ms
#> # ℹ 4 more variables: result <list>, memory <list>, time <list>, gc <list>
# }
```
